...
def get_zhang_et_all_myofibers_sra_ids():
...
output_dir = '/media/awmundy/Windows/bio/senescence_skeletal_muscle/raw_rna_txs/'
log_dir = '/media/awmundy/Windows/bio/senescence_skeletal_muscle/logs/'
os.makedirs(output_dir, exist_ok=True)
os.makedirs(log_dir, exist_ok=True)
sra_ids = get_zhang_et_all_myofibers_sra_ids()
